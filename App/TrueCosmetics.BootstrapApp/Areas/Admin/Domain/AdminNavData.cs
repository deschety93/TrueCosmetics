...
namespace TrueCosmetics.BootstrapApp.Areas.Admin.Domain
{
    public class AdminNavData
    {
        public IEnumerable<Navbar> navbarItems()
        {
            var menu = new List<Navbar>();
            menu.Add(new Navbar { Id = 1, nameOption = "Начало", controller = "Home", action = "Index", imageClass = "fa fa-dashboard fa-fw", status = true, isParent = false, parentId = 0 });
            ...
            menu.Add(new Navbar { Id = 2, nameOption = "Категории продукти", imageClass = "fa fa-table fa-fw", status = true, isParent = true, parentId = 0 });
            menu.Add(new Navbar { Id = 3, nameOption = "Всички категории продукти", controller = "Categories", action = "Index", imageClass = "fa fa-table fa-fw", status = true, isParent = false, parentId = 2 });
            menu.Add(new Navbar { Id = 4, nameOption = "Категории продукти по пол", controller = "GenderCategories", action = "Index", imageClass = "fa fa-table fa-fw", status = true, isParent = false, parentId = 2 });
            menu.Add(new Navbar { Id = 5, nameOption = "Управление на акаунти", controller = "ApplicationUsers", action = "Index", imageClass = "fa fa-edit fa-fw", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 6, nameOption = "Производители", controller = "Manufacturers", action = "Index", imageClass = "fa fa-edit fa-fw", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 7, nameOption = "Продутки", controller = "Products", action = "Index", imageClass = "fa fa-edit fa-fw", status = true, isParent = false, parentId = 0 });
            menu.Add(new Navbar { Id = 8, nameOption = "Поръчки", controller = "Orders", action = "Index", imageClass = "fa fa-edit fa-fw", status = true, isParent = false, parentId = 0 });
